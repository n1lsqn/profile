...
const Home = () => {
  return (
    <div className="bg-[url('/assets/bg_blur.webp')] bg-cover flex flex-col justify-center items-center min-h-screen p-4 relative before:absolute before:inset-0 before:bg-purple-950/20 before:pointer-events-none">
